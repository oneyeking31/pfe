...
public class Prof_profile_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.prof_account_fragment, container, false);
        ...
        if (status.equals("loggedout")) {
            ...
            String Res = accountinfo.getString("accounresttype", "null");
            namespace.setText(N);
            if (T.equals("Adminstrator")) {
                typespace.setText(T);

            } else {
                typespace.setText(Res);
